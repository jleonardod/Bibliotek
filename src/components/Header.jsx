    ...
    <header className="h-[7vh] md:h-[10vh] border-b border-primary p-2 flex justify-between align-items-center ">
      ...
      <div className="">
        <div className="flex justify-between items-center h-full gap-4">
          <button onClick={() => setShowNotification(!showNotification)} className="bg-white rounded-full p-2 cursor-pointer">
            <RiNotification2Line className="text-2xl" />
          </button>
          <button onClick={() => setShowMensajes(!showMensajes)} className="bg-white rounded-full p-2 cursor-pointer">
      ...
      <div className={`${!showNotification ? "hidden" : "absolute" } right-36 top-14 border-gray-500 border-solid border-b border-l border-r border-t w-96`}>
      ...
      <div className={`${!showMensajes ? "hidden" : "absolute" } right-20 top-14 border-gray-500 border-solid border-b border-l border-r border-t w-96`}>
